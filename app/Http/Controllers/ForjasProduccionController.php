...
use App\Models\ForjasProduccion;


class ForjasProduccionController extends Controller
{

      // Método para mostrar la vista con el gráfico
      public function index()
      {
          return view('forjas_produccion');
      }
      ...
      public function store(Request $request)
      {
          ...
          $cumplimiento = ForjasProduccion::updateOrCreate(
      ...
      {
          $cumplimiento = ForjasProduccion::all();
